        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateSortiePrevue = table.Column<DateOnly>(type: "date", nullable: false),
                    DateSortieReelle = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeLogiciel = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    DatePubli = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
